...
public class SecurityConfig {
	...
	/*
	 * @Bean public UserDetailsService userDetailsService() { // users create //
	 * InMemoryUserDetailsManager- is implementation class of UserDetailService
	 * 
	 * UserDetails normalUser =
	 * User.builder().username("RITIKA").password(passwordEncoder().encode("ritu"))
	 * .roles("NORMAL").build();
	 * 
	 * UserDetails adminUser =
	 * User.builder().username("AJAY").password(passwordEncoder().encode("ajay"))
	 * .roles("ADMIN").build();
	 * 
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		http.csrf().disable().authorizeRequests().antMatchers("/auth/login").permitAll().antMatchers("/auth/google")
